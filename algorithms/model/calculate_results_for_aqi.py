...
pm2_5_model = joblib.load(r'B:\Computer Science and Engineering\BOIHackathon - AQI Model for AI\algorithms\model\models__train=1\Random_Forest_Regression_pm2_5.pkl')
pm10_model = joblib.load(r'B:\Computer Science and Engineering\BOIHackathon - AQI Model for AI\algorithms\model\models__train=1\Random_Forest_Regression_pm10.pkl')
scaler = joblib.load(r'B:\Computer Science and Engineering\BOIHackathon - AQI Model for AI\algorithms\model\models__train=1\scaler.pkl')
...
def calculate_air_quality_manually(co, no, no2, o3, so2, nh3):
    print("Hello from ", calculate_air_quality_manually.__name__)
