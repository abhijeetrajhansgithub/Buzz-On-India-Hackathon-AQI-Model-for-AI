...
gradient_boosting_regression_model_path_POWAC = os.path.join(model_dir,
                                                             "mm_model_1__training___model_training_for_POWAC",
...
gradient_boosting_regression_model_path_POWAC_ND = os.path.join(model_dir,
...
model = joblib.load(gradient_boosting_regression_model_path_POWAC)


# Prediction function
def multimodal_model_1__gradient_boosting__calculate_air_quality__POWAC(model_, encoder_, scaler_, feature_names_):
...
predicted_aqi = multimodal_model_1__gradient_boosting__calculate_air_quality__POWAC(model, encoder, scaler,
                                                                                    feature_names)
...
def multimodal_model_1__gradient_boosting__calculate_air_quality__POWAC_ND(model_path, preprocessor):
...
def get_multimodal_model_1__gradient_boosting__calculate_air_quality__POWAC_ND():
    return multimodal_model_1__gradient_boosting__calculate_air_quality__POWAC_ND(gradient_boosting_regression_model_path_POWAC_ND, preprocessor_POWAC_ND)


def get_multimodal_model_1__gradient_boosting__calculate_air_quality__POWAC():
    return multimodal_model_1__gradient_boosting__calculate_air_quality__POWAC(model, encoder, scaler, feature_names)
