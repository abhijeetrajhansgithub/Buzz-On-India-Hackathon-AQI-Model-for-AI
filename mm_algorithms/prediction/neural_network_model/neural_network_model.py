...
neural_network_regression_model_path_POWAC = os.path.join(model_dir, "mm_model_1__training___model_training_for_POWAC",
                                                          "neural_network_regression_(mlp)_model.pkl")
...
neural_network_regression_model_path_POWAC_ND = os.path.join(model_dir,
...
model = joblib.load(neural_network_regression_model_path_POWAC)


# Prediction function
def multimodal_model_1__neural_network__calculate_air_quality__POWAC(model_, encoder_, scaler_, feature_names_):
...
predicted_aqi = multimodal_model_1__neural_network__calculate_air_quality__POWAC(model, encoder, scaler, feature_names)
...
def multimodal_model_1__neural_network__calculate_air_quality__POWAC_ND(model_path, preprocessor):
...
predicted_aqi_nd = multimodal_model_1__neural_network__calculate_air_quality__POWAC_ND(
    neural_network_regression_model_path_POWAC_ND, preprocessor_POWAC_ND)
